...
/*optiongrad::optiongrad(int offset,int opacity,Couleur couleur)
{
    m_offset=offset;
    m_opacity=opacity;
    m_couleur=couleur;
}
gradient::gradient(int x1, int y1, int x2, int y2, std::vector<optiongrad*> listegrad)
{
    m_x1=x1;
    m_y1=y1;
    m_x2=x2;
    m_y2=y2;
    m_listegrad=listegrad;
}
gradient::gradient()
{
...
/*void Svgfile::addrectanglegradient(double x1, double y1, double x2, double y2,double x3, double y3,double x4, double y4, gradient g)
{
    int static z=0;
    m_ostrm<<" \n\n<defs>\n"
...
void Svgfile::addcarre(double x1, double y1, double x2, double y2, std::string color)
{
    addTriangle(x1,y1,x1,y2,x2,y2,color);
    addTriangle(x1,y1,x2,y1,x2,y2,color);
}
